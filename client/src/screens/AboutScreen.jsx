    ...
    <section className="min-h-screen flex flex-col justify-center items-center pt-20 pb-10 px-10 sm:px-16 bg-gradient-to-b from-orange-200 to-orange-100">
      <div className="flex flex-row justify-center items-center">
        <img
          src={Logo}
          alt="PizzaHub Logo"
          className="hidden sm:block h-32 w-35"
        />
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6">
        <article className="mb-4">
          ...
          <p className="text-gray-800 text-lg leading-relaxed">
            PizzaHub is a pizza ordering app that allows you to create your
        ...
        <article className="mb-4">
          ...
          <p className="text-gray-800 text-lg leading-relaxed">
            ...
            <a
              href="pizzaapp.notifications@gmail.com"
              className="text-orange-500 hover:text-orange-700"
            >
              pizzaapp.notifications@gmail.com
            </a>
          </p>
        </article>
      </div>
